...
def update_output_container(selected_year, selected_statistics):
    if selected_statistics == 'Recession Period Statistics':
        if selected_year == 'Select Year':
            return html.Div("Please select a year to view statistics.")
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2 = dcc.Graph(figure=px.line(average_sales, x='Vehicle_Type', y='Automobile_Sales',
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        R_chart4 = dcc.Graph(figure=px.bar(yearly_data, x='unemployment_rate', y='Automobile_Sales', 
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yearly_sales, x='Month', y='Automobile_Sales',
                                            title=f"Yearly Automobile Sales in {selected_year}"))
...
# Plot 2 Total Monthly Automobile sales using line chart.
    ...
    avr_sales = yearly_data.groupby('Vehicle_Type')['Automobile_Sales'].mean().reset_index()
    Y_chart3 = dcc.Graph(figure=px.bar(avr_sales, x='Vehicle_Type', y='Automobile_Sales',
